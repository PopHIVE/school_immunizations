...
if (!identical(process$raw_state, raw_state) ||
  ...
  vroom::vroom_write(add_state_column(data_out, "Hawaii"), "./standard/data.csv.gz", delim = ",")
  vroom::vroom_write(add_state_column(data_out, "Hawaii"), "./standard/data.csv", delim = ",")
